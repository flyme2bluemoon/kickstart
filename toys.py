...
for t in range (1, T + 1):
    ...
    for i in range(len(the_sum_values)):
        ...
        # print(type(the_toy_pqueue.queue[0]))

        while not the_toy_pqueue.empty():
            the_top_of_pqueue = list(the_toy_pqueue.queue[0]) # the_sum_and_index
    ...
    if not the_toy_pqueue.empty():
        print("Case #{}: {} INDEFINITELY".format(t, the_removed))
    else:
        print("Case #{}: {} {}".format(t, the_min_removed, the_max_time))